...
const cards = [
  {
    ...
    description: "Devemos criar um tópico no SNS com o objetivo de alimentar nossas aplicações.",
    status: "backlog",
    priority: 3,
    blocked: false,
    userId: 1,
  ...
  },
  {
    ...
    description: "Devemos criar uma tela de login para realizar a autenticação dos nossos usuários.",
    status: "doing",
    priority: 3,
    blocked: false,
    userId: 2,
  ...
  },
  {
    ...
    description: "Devemos criar uma página de blog para permitir a criação de postagens.",
    status: "doing",
    priority: 3,
    blocked: false,
    userId: 2,
  ...
  },
  {
    ...
    description: "Devemos validar o prótotipo da tela de recuperação de senha criada.",
    status: "qa",
    priority: 2,
    blocked: true,
    userId: 1,
